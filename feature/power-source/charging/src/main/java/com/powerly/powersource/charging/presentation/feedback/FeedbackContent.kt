...
internal val emojis = listOf(
    Emoji(1, R.string.feedback_terrible, R.drawable.feedback_terrible),
    Emoji(2, R.string.feedback_bad, R.drawable.feedback_bad),
    Emoji(3, R.string.feedback_fine, R.drawable.feedback_fine),
    Emoji(4, R.string.feedback_good, R.drawable.feedback_good),
    Emoji(5, R.string.feedback_excellent, R.drawable.feedback_excellent),
)

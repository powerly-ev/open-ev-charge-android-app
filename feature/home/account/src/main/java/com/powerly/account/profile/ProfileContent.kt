    ...
    MyScreen(
        ...
        MyColumn(
            ...
            MyTextField(
                ...
                error = { stringResource(R.string.enter_your_first_name) },
                isError = { firstNameInvalid },
                label = stringResource(R.string.first_name_title),
                onValueChange = {
            ...
            MyTextField(
                ...
                label = stringResource(R.string.last_name_title)
            )
            MyTextField(
                value = email,
                error = { stringResource(R.string.require_email_address) },
            ...
            MyTextField(
                ...
                label = stringResource(R.string.vatId_title)
            )
            MyPasswordTextField(
                value = password,
                modifier = Modifier.fillMaxWidth(),
...
private fun SectionHeader(
    ...
    CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
        Row(
            ...
            Text(
                text = stringResource(R.string.myProfile_title),
